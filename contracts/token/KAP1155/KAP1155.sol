...
// OpenZeppelin Contracts v4.4.1 (token/KAP1155/KAP1155.sol)
 ...
 * Originally based on code by Enjin: https://github.com/enjin/kap-1155
 *
...
contract KAP1155 is Context, KAP165, IKAP1155, IKAP1155MetadataURI {
    ...
    /**
     * @dev See {IKAP1155MetadataURI-uri}.
     *
    ...
    /**
     * @dev See {IKAP1155-balanceOfBatch}.
     *
     * Requirements:
     *
    ...
    /**
     * @dev See {IKAP1155-safeTransferFrom}.
     */
    function safeTransferFrom(
        ...
        require(
            ...
            "KAP1155: caller is not owner nor approved"
        );
        _safeTransferFrom(from, to, id, amount, data);
    }

    /**
     * @dev See {IKAP1155-safeBatchTransferFrom}.
     */
     ...
     * - If `to` refers to a smart contract, it must implement {IKAP1155Receiver-onKAP1155Received} and return the
    ...
    /**
     * @dev xref:ROOT:kap1155.adoc#batch-operations[Batched] version of {_safeTransferFrom}.
     *
     * Emits a {TransferBatch} event.
     *
     * Requirements:
     *
     * - If `to` refers to a smart contract, it must implement {IKAP1155Receiver-onKAP1155BatchReceived} and return the
     * acceptance magic value.
     */
    ...
    /**
     * @dev xref:ROOT:kap1155.adoc#batch-operations[Batched] version of {_mint}.
     *
     * Requirements:
     *
    ...
    /**
     * @dev xref:ROOT:kap1155.adoc#batch-operations[Batched] version of {_burn}.
     *
     * Requirements:
     *
     * - `ids` and `amounts` must have the same length.
