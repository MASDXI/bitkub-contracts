...
contract KAP721 is Context, KAP165, IKAP721, IKAP721Metadata, KYCHandler, Committee, Pausable, Authorization {
    ...
    /**
     * @dev See {IKAP721Metadata-symbol}.
     */
    ...
    /**
     * @dev See {IKAP721-safeTransferFrom}.
     */
     ...
     * are aware of the KAP721 protocol to prevent tokens from being forever locked.
     *
     ...
     * - If `to` refers to a smart contract, it must implement {IKAP721Receiver-onKAP721Received}, which is called upon a safe transfer.
     *
    ...
    /**
     * @dev Same as {xref-KAP721-_safeMint-address-uint256-}[`_safeMint`], with an additional `data` parameter which is
     * forwarded in {IKAP721Receiver-onKAP721Received} to contract recipients.
     */
    function _safeMint(
        address to,
        uint256 tokenId,
    ...
    function _setApprovalForAll(
        ...
        require(owner != operator, "KAP721: approve to caller");
        _operatorApprovals[owner][operator] = approved;
        emit ApprovalForAll(owner, operator, approved);
    }

    /**
     * @dev Internal function to invoke {IKAP721Receiver-onKAP721Received} on a target address.
